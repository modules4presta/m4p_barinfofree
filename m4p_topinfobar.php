...
require_once dirname(__FILE__) . '/classes/Modules4PrestaMarketingTopinfobar.php';
class m4p_topinfobar extends Module
{
    public $content = '';
    public function __construct()
    {
        $this->name = 'm4p_topinfobar';
    ...
    public function getContent()
    {
        ...
        $this->context->smarty->assign(array(
            'modules_ads' => Modules4PrestaMarketingTopinfobar::getAdsFromModules4Presta()
        ));
    ...
    public array $DB_tables = ["m4p_topinfobar"];
    ...
    public function uninstallQueries()
    {
        ...
        foreach ($this->DB_tables as $table) {
            if (Db::getInstance()->execute("DROP TABLE IF EXISTS `".m4p_msc_clarity::getPrefixDb().$table."`;") === false) {
                return false;
            }
        }
        return true;
